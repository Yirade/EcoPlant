...
from .views import LoginView, RegistrationView, UserDeviceDataView, DeviceDataView, DeviceRegistrationView, UserDevicesView, DeviceSensorDataView, UserDetailView, TokenCheckView
